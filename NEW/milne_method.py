...
def milne_app():
    ...
    st.info(
        "Milne’s Predictor-Corrector Method is used to solve ordinary "
        "differential equations numerically using previously known "
        "values to predict and then correct the next value."
    )
    ...
    if st.button("Compute"):
        ...
        try:
            ...
            if len(xs) != 4 or len(ys) != 4:
                ...
                st.error("Please enter exactly four values.")
                ...
                data = {
                    ...
                    "Value": [round(y_pred,6), round(y_corr,6)]
                }
